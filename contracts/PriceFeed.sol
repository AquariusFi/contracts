...
contract PriceFeed is Ownable, CheckContract, BaseMath, IPriceFeed {
    ...
    */
    ...
    address chainlinkAddressSetter;
    ...
    onlyOwner
    {
        chainlinkAddressSetter = msg.sender;
    ...
    */
    ...
    function _getCurrentBandResponse() internal view returns (IStdReference.ReferenceData memory bandResponse){
        return bandCaller.getReferenceData("FTM", "USD");
    }
    ...
    function setChainlinkAddress(address _priceAggregatorAddress) external {
        require(chainlinkAddressSetter == msg.sender, "PriceFeed: Invalid identity");
        checkContract(_priceAggregatorAddress);
        ...
        // renounce chainlinkAddressSetter
        chainlinkAddressSetter = address(0);
    }
}
