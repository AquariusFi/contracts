 ...
 */
contract AQUUnipool is LPTokenWrapper, Ownable, CheckContract, IUnipool {
    string constant public NAME = "AQUUnipool";
        ...
        onlyOwner
    {
        ...
        _notifyRewardAmount(lqtyToken.getAQULpRewardsEntitlement(), _duration);
