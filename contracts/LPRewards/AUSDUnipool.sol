 ...
 */
contract AUSDUnipool is LPTokenWrapper, Ownable, CheckContract, IUnipool {
    string constant public NAME = "AUSDUnipool";
        ...
        onlyOwner
    {
        ...
        _notifyRewardAmount(lqtyToken.getAUSDLpRewardsEntitlement(), _duration);
